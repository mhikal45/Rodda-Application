package com.rodda.firstpage.ui.mainpage
...
import com.rodda.firstpage.ui.mainpage.databinding.ActivityPageMainBinding
...
class PageMainActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.page_main, menu)
        return true
    }
